        ...
        for j, day in enumerate(days):
            ...
            if i==3:
                ...
                if (i,j)==(0,2):
                    ...
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Data-Centric Computing", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: Jasubhai Auditorium", fill="black", font=inside_font) 
                elif (i,j)==(1,1):
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Probability statistics and", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"Data Visualization", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: Jasubhai Auditorium", fill="black", font=inside_font)
                elif (i,j)==(1,2):
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Ordinary Differential Equation", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: Jasubhai Auditorium", fill="black", font=inside_font)
                elif (i,j)==(1,3):
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Design, Innovation, and Prototyping", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: Jasubhai Auditorium", fill="black", font=inside_font)
                elif (i,j)==(1,4):
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Ordinary Differential Equation", fill="black", font=inside_font)
                    ...
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Principles and application of", fill="black", font=inside_font)
                    ...
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"Electrical Engineering", fill="black", font=inside_font)
                    if rn<20:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/101", fill="black", font=inside_font)
                    elif rn<50:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/103", fill="black", font=inside_font)
                    elif rn<75:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/104", fill="black", font=inside_font)
                    elif rn<100:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/105", fill="black", font=inside_font) 
                    elif rn<120:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/110", fill="black", font=inside_font)
                    elif rn<150:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/201", fill="black", font=inside_font)
                    elif rn<170:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/204", fill="black", font=inside_font) 
                    elif rn<200:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/205", fill="black", font=inside_font)
                    elif rn<220:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/206", fill="black", font=inside_font)
                    elif rn<250:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: 7/210", fill="black", font=inside_font)
                elif (i,j)==(2,3):
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Principles and application of", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"Electrical Engineering", fill="black", font=inside_font)
                    ...
                    if section==4:
                        ...
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Principles and application of", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"Electrical Engineering", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 190), f"venue: EE Lab(AB 6)", fill="black", font=inside_font)
                    elif section==5:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lab", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Design, Innovation, and Prototyping", fill="black", font=inside_font)
                        ...
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lab", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Undergraduate Science Laboratory", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: PH Lab", fill="black", font=inside_font)
                    else:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Free", fill="black", font=inside_font)
                    ...
                    if section==1:
                        ...
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Tutorial", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"Writing ", fill="black", font=inside_font)
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: 10/101", fill="black", font=inside_font)
                    else:
                        draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Free", fill="black", font=inside_font)
                    ...
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 110), f"Lecture", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 140), f"General Education I", fill="black", font=inside_font)
                    draw.text((j * inside_box_size[0] + 240, i * 150 + 170), f"venue: Central Arcade", fill="black", font=inside_font)
